...
async function loadBookings() {
  try {
    ...
    const res = await fetch("https://onfleekhairven.onrender.com/api/admin/bookings", {
      headers: {
...
async function confirmPayment(id) {
  try {
    ...
    const res = await fetch(`https://onfleekhairven.onrender.com/api/admin/bookings/${id}/confirm`, {
      method: "PATCH",
      headers: {
        Authorization: `Bearer ${token}`,
      },
...
async function loadBlockedDates() {
  const res = await fetch("https://onfleekhairven.onrender.com/api/availability");
...
blockDateBtn.addEventListener("click", async () => {
  ...
  try {
    const res = await fetch("https://onfleekhairven.onrender.com/api/block-dates", {
      method: "POST",
      headers: {
...
async function removeBlockedDate(date) {
  await fetch(`https://onfleekhairven.onrender.com/api/availability/${date}`, {
  method: "DELETE",
...
blockMonthBtn.addEventListener("click", async () => {
  ...
  try {
    ...
    const res = await fetch("https://onfleekhairven.onrender.com/api/block-month", {
      method: "POST",
...
async function loadBlockedMonths() {
  try {
    const res = await fetch("https://onfleekhairven.onrender.com/api/blocked-months");
...
async function unblockMonth(id, liElement) {
  try {
    const res = await fetch(`https://onfleekhairven.onrender.com/api/unblock-month/${id}`, { method: "DELETE" });
    const data = await res.json();
